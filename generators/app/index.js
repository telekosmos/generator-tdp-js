...
// TODO: ideally, this would ensure that the version is valid as per NPM rules/best practice (lower case, hyphens)
    ...
    // NOTE: this is the full list of current (July 2016), OSI approved SPDX licenses from https://spdx.org/licenses/
    const validLicenses =
    [
        "0BSD",
        "AAL",
    ...
    this.GTNOpts.license = validLicenses.indexOf(this.options.license) >= 0 ? this.options.license : "MIT";
